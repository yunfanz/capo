...
sns.set(style="ticks", color_codes=False,font='DejaVu Serif', font_scale=2)
def freq_compare():
...
def freq_compare_v2():
    ...
    T1 = np.arange(2456681.4, 2456681.65, 0.001)
    DT = T1-np.mean(T1)
    for fqs in FQS:
    #fqs = Afqs[110:161]
        ...
        #res = WS.opp(bl1=(0,26), bl2=(0,26), return_series=True)
        #res2 = WS.opp(bl1=(0,26), bl2=(0,38), return_series=True)
        res = WS.opp(bl1=(0,26), bl2=(0,26), return_series=True, rephase=0)
        res2 = WS.opp(bl1=(0,26), bl2=(0,38), return_series=True, rephase=0)
        RES.append(res)
        RES2.append(res2)
        res3 = WS.opp(bl1=(0,26), bl2=(0,26), return_series=True, rephase=104.936)
        res4 = WS.opp(bl1=(0,26), bl2=(0,38), return_series=True, rephase=104.936)
        RES3.append(res3)
        RES4.append(res4)
